...
In this paper, we demonstrate efficient training of a CNN on the CIFAR10 dataset (93\% accuracy within 77 minutes) on an Nvidia GTX750 with only 1GB of memory.
...
We demonstrate the efficiency of our method by efficiently training a model to 93\% accuracy on the CIFAR10 dataset within 1 hour and 17 minutes on a low-end Nvidia GTX750 with only 1GB of VRAM.
...
>>>>>>> 2efb133a26ec83af1850c623d802712c5cd2d35a
