...
Figure 11 shows the accumulation of numerical errors along the layers of both architectures,
in order to visualize these phenomenon.
This figure suggests that layer-wise invertible architecture can not scale with depth
...
Figure 12 quantifies the degradation of the inverse reconstruction for the two models.
...
In Figure 13, we show evolution of the accuracy with increasing depth.
...
(right) the layer-wise invertible architecture and (left) the hybrid architecture.
