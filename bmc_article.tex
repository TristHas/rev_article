...
\frac{|\epsilon^y|^2}{|\epsilon^x|^2} =& c \times \sum_i \frac{\dot{x_i}}{\gamma_i}
\end{align}
\end{subequations}
...
\alpha              =& \frac{\sum_i (\hat{x}_i^2 + \dot{x_i}^2)}{\sum_i (\gamma_i^2 + \beta_i^2)} \times \sum_i \frac{\dot{x_i}}{\gamma_i} \times c  
\end{align}
\end{subequations}
...
In this figure, we also verify the validity of our general formula for arbitrarily parameterized
layer by comparing the theory to empirical evaluations.
