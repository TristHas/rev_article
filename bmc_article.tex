...
(Left) Comparison of the theoretical and empirical evolution of the $\alpha$ ratio for different $\rho$ values in our toy example.
...
(Right) Comparison of the theoretical and empirical evolution of the $\alpha$ ratio for different for arbitrarily parameterized layers.
Empirical values were computed for random Gaussian input signal and a white Gaussian noise of standard deviation $10^{-5}$.
}
\end{figure}
